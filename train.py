...
class Yolo_loss(nn.Module):
    def __init__(self, n_classes=80, n_anchors=3, device=None, batch=2):
        ...
        self.anchors = [[12, 16], [19, 36], [40, 28], [36, 75], [76, 55], [72, 146], [142, 110], [192, 243], [459, 401]]    # 9个
...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=10, img_scale=0.5):
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img', ncols=None) as pbar:
...
def get_args(**kwargs):
    ...
    parser.add_argument('-g', '--gpu', metavar='G', type=str, default='1',
                        help='GPU', dest='gpu')
    parser.add_argument('-dir', '--data-dir', type=str, default='/kaggle/',
